...
public class TabelIsiPercobaan4e extends AppCompatActivity {
    EditText ek1b1,ek2b1,ek1b2,ek2b2,ek1b3,ek2b3,ek1b4,ek2b4,ek1b5,ek2b5;
    Button simpan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tabel_isi_percobaan4e);
        ...
        simpan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(TabelIsiPercobaan4e.this, "Menyimpan Jawaban", Toast.LENGTH_SHORT).show();
            }
        });
    }

...
public class IsiPercobaan4b extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_isi_percobaan4b);
        ...
        Glide.with(this).load(R.drawable.t4b).into(imageView0);
        ...
        Glide.with(this).load(R.drawable.ip4b).into(imageView);

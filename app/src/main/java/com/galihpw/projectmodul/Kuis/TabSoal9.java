...
public class TabSoal9 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.tab_soal9, container, false);
        ...
        rG.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, @IdRes int i) {
                ...
                Hasil.jwb[8] = rB.getText().charAt(0);

                Toast.makeText(getActivity(), ""+Hasil.jwb[8], Toast.LENGTH_SHORT).show();
            }
        });
        return rootView;
    }

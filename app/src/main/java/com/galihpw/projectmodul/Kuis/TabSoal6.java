package com.galihpw.projectmodul.Kuis;
...
public class TabSoal6 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.tab_soal6, container, false);
        ...
        rG.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, @IdRes int i) {
                ...
                Hasil.jwb[5] = rB.getText().charAt(0);

                Toast.makeText(getActivity(), ""+Hasil.jwb[5], Toast.LENGTH_SHORT).show();
            }
        });
        return rootView;
    }
